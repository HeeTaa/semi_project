...
<!-- 내정보 수정 -->
    ...
    <div class="container w-50">
      ...
      <form id="modifyForm" action="${pageContext.request.contextPath}/businessModifyInfoProc.mem" method="get">
           <div class="row p-2">
             <div class="col-12 ">
               <label for="pw" class="form-label">이름(실명)</label>
            </div>
            <div class="col-6 mb-2 sm-1">
               <input type="text" class="form-control" id="name" name="name" value="${dto.getName()}" readonly>
            </div>
         </div>
         <div class="row p-2">
            <div class="col-12">
         ...
         <div class="row p-2">
            ...
            <div class="row p-2">
               ...
               <div class="col-xs-6 col-sm-3">
                  <input type="text" class="form-control" id="phone3" name="phone3" readonly>
               </div>
            ...
            <div class="row p-2">
            	<div class="col-12">
              	...
              	<div class="col-6 mb-2 sm-1x">
               		<input type="text" class="form-control" id="business_no" name="business_no" value="${dto.getBusiness_no()}" readonly>
              	</div>
             </div>
             ...
             <div class="row p-2">
                ...
                <div class="col-6 mb-2 sm-1x businessImg">
                  <img class="../imagesize" src="${pageContext.request.contextPath}/${filedto.getFileAddr()}/${filedto.getSystem_name()}">
                </div>
             </div>
                       ...
                       <label for="addr" class="form-label">운동 센터 주소</label>
                        <div class="col-6 mb-2 sm-1">
                            ...
                            <input type="text" class="form-control" id="postCode"
                                name="postCode" placeholder="우편번호" value="${dto.getPostcode()}"readonly>
                        </div>
                        <div class="col-6 mb-2 sm-1">
                            <button type="button" class="btn btn-warning" id="btnPostCode">우편번호 찾기</button>
                        </div>
                    </div>
            ...
            <div class="row p-2">
               <div class="col-6 mb-2 sm-1">
                  <input type="text" class="form-control" id="roadAddr"
                     name="roadAddr" placeholder="도로명주소" value="${dto.getRoadAddr()}" readonly>
               </div>
            </div>
            ...
            <div class="col-6 mb-2 sm-1">
                  <input type="text" class="form-control" id="extraAddr"
                     name="extraAddr" placeholder="읍/면/동" value="${dto.getExtraAddr()}" readonly>
               </div>
               <div class="col-6 mb-2 sm-1">
                  <input type="text" class="form-control" id="detailAddr"
                     name="detailAddr" placeholder="상세주소" value="${dto.getDetailAddr()}" readonly>
               </div>
            </div>    
...
<div class="gab"></div>
            ...
            <div class="row">
               <div class="col-3"></div>
			      <div class="col-3">
                  <p class="text_center">
                     <button type="button" class="btn btn-secondary" id="btnCenterSignup">센터 등록</button>
                  </p>
               ...
               <div class="col-3">
                  <p class="text_center">
                     <button type="button" class="btn btn-warning" id="btnCenterPage">센터 페이지</button>
                  </p>
			      </div>
               <div class="col-3"></div>
		      </div>
			...
			<nav class="col" aria-label="Page navigation example">
			  <ul class="pagination justify-content-center">
				  <c:if test="${naviMap.get('needPrev') eq true}">
				  	<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/toMyPage.mem?currentPage=${naviMap.get('startNavi')-1}">Previous</a></li>
				  </c:if>
				  <c:forEach var="i" begin="${naviMap.get('startNavi')}" end="${naviMap.get('endNavi')}">
				  	<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/toMyPage.mem?currentPage=${i}">${i}</a></li>
				  </c:forEach>
				  <c:if test="${naviMap.get('needNext') eq true}">
				  	<li class="page-item"><a class="page-link" href="${pageContext.request.contextPath}/toMyPage.mem?currentPage=${naviMap.get('endNavi')+1}">Next</a></li>
				  </c:if>			    
			  </ul>
			</nav>
		</div>
...
<!-- 하단 센터등록 구분 문구 COPY -->    
<div class="gab"></div>
<div class="container-fluid bag_ivory">
