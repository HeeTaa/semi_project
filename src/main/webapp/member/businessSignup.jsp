...
<body>
	...
	<div class="container ">
		...
		<form id="businessSignupForm" name="businessSignupForm"
			action="${pageContext.request.contextPath}/businessSignupProc.mem"
			...
			<div class="row p-2">
				<div class="col-2"></div>
				<div class="col-1 content">사업자등록번호</div>
				<div class="col-4 mb-2 sm-1x">
			...
			<div class="row p-2">
            <div class="col-2"></div>
            <div class="col-1 content">사업자번호 등록증</div>
            <div class="col-4 mb-2 sm-1x">
			...
			<div class="row p-2">
				<div class="col-2"></div>
				<div class="col-1 content">주소</div>
				<div class="col-4 mb-2 sm-1">
					<input type="text" class="form-control" id="postCode"
						name="postCode" placeholder="우편번호" readonly>
				</div>
				<div class="col-4 mb-2 sm-1">
					<button type="button" class="btn btn-primary" id="btnPostCode">우편번호
						찾기</button>
				</div>
			</div>
		...
		document
				...
				.addEventListener(
						...
						function() {
							...
							let business_no = document
									.getElementById("business_no");
							...
							let detailAddr = document
									.getElementById("detailAddr");
							let extraAddr = document
									.getElementById("extraAddr");
							...
							if (!regexPw.test(pw.value) || pw.value == "") {
								alert("비밀번호를 올바르게 입력하세요.");
								return;
							} else if (pw.value !== document
									.getElementById("pwCheck").value) {
								alert("비밀번호 확인을 올바르게 입력하세요.");
								return;
							} else if (!regexNickname.test(nickname.value)
									|| nickname.value == "") {
								...
								alert("이름을 입력하세요.");
								return;
							} else if (!regexBusiness_no
									.test(business_no.value)
									|| business_no.value == "") {
								alert("사업자 등록번호를 올바르게 입력하세요.");
								return;
							} else if (id.value == "") {
								alert("아이디를 입력하세요.");
								return;
