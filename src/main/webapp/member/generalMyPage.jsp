...
<!-- 내 정보 수정 -->
    <div class="container w-50">
		<form id="modifyForm" action="${pageContext.request.contextPath}/generalModifyInfoProc.mem" method="post">
           <div class="row p-2">
			 	<div class="col-12 ">
			...
			<div class="row p-2">
				...
				<div class="row p-2">
					...
					<div class="col-3 mb-2 sm-1">
						<button type="button" class="btn btn-warning w-100" id="btnPostCode">우편번호
							찾기</button>
					</div>
				</div>
				<div class="row p-2">
...
<fieldset class="boardBox">
    <h2 class=" text_gradation_blue"></h2>
		<legend>
			<h2 class=" text_gradation_blue">내가 쓴 게시글</h2>
		</legend>
		<div class="container">
			<br>
